                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="/updateUser">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="username" name="username"
                                        placeholder="Enter Your Username" value="${user.getUsername()}" readonly="">
                                        <input type="hidden" name="id" id="id" value="${user.getId()}">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="password" name="password" placeholder="Enter Your Password" onkeyup="checkPass();" value="${user.getPassword()}">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="repeatPassword" placeholder="Repeat Your Password" onkeyup="checkPass();" value="${user.getPassword()}">
                                    </div>
                                </div>
